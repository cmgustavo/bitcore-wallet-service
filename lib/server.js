      ...
      self.getWallet({}, function(err, wallet) {
        ...
        if (wallet.coin == 'bch') {
          status.serverMessage = {
            title: 'Bitcoin Cash (BCH) Protocol Changes in Progress',
            body: 'The Bitcoin Cash network is currently undergoing disruptions due to protocol changes. We advise against sending or receiving BCH payments until the fork is over',
            link: 'https://hola.com'
          };
        }
        next();
